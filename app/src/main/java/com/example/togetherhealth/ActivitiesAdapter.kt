...
class ActivitiesAdapter(private val data: MutableList<PhysicalActivity>, private val onClickObject:ActivitiesAdapter.MyOnClick) :
    ...
    class ViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        ...
        val ActivityName: TextView = itemView.findViewById(R.id.textViewName)
        val ActivitySets: TextView = itemView.findViewById(R.id.textViewSets)
        val ActivityDuration: TextView = itemView.findViewById(R.id.textViewDuration)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.ActivityName.text = ItemsViewModel.name
        holder.ActivitySets.text = ItemsViewModel.sets.toString()
        holder.ActivityDuration.text = ItemsViewModel.durationInMin.toString()
